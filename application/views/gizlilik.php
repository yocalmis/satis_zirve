İşbu Gizlilik Politikası’nın amacı, <?php echo DOMAIN; ?> adresinde yer alan siteye (“Site”) üye olarak kaydolan kişiler (“Kullanıcı(lar)”) tarafından Site’de yer alan Platform’dan faydalanılması aşamasında <?php echo FİRMA_NAME; ?> (“Şirket”) ile paylaşılan bilgi ve verilerin kullanımına ilişkin koşul ve şartları tespit etmektir. Gizlilik Politikası, Kullanıcı ile akdedilen Kullanıcı Sözleşmesi’nin eki ve ayrılmaz bir parçası niteliğindedir.<br><br>

Kullanıcı tarafından Site’ye yüklenen İçerik Kullanıcı’nın mülkiyetindedir. Şirket, bu İçerik’i Kullanıcı’nın önceden onayını almaksızın açıklamayacak veya satmayacaktır.<br><br>

Şirket, Site üzerinden kendisine elektronik ortamdan iletilen İçerikleri’i Kullanıcılar ile yaptığı Kullanıcı Sözleşmesi ile belirlenen amaçlar ve kapsam dışında üçüncü kişilere açıklamayacaktır. Bu kapsamda Şirket, İçerikler’i kesinlikle özel ve gizli tutmayı, bunu bir sır saklama yükümü olarak addetmeyi ve gizliliğin sağlanması ve sürdürülmesi, gizli bilginin tamamının veya herhangi bir kısmının kamu alanına girmesini veya yetkisiz kullanımını veya üçüncü bir kişiye ifşasını önlemek için gerekli tüm tedbirleri almayı ve gerekli özeni göstermeyi taahhüt etmektedir.<br><br>

Kullanıcı’nın Şirket’e onay vermesi halinde ödeme işlemleri, fatura kesimi ve işlenmesi, banka entegrasyonu, Kullanıcı’nın erişimine izin verdiği üçüncü kişi uygulamaları ve doğrudan pazarlama gibi amaçlarla Kulllanıcı’nın verdiği onay çerçevesinde İçerikler işlenebilir, saklanabilir ve Şirket ile ortakları tarafından Kullanıcı’nın talep ettiği hizmetleri sağlamak üzere üçüncü kişilere devredilebilir.<br><br>

Şirket, İçerikler’i fatura gönderilmesi, ödeme bilgilerinin paylaşılması gibi talep edilen hizmetlerin sağlanması amacıyla diğer kullanıcılara açıklayabilecektir. Kullanıcı’nın diğer kullanıcıya ait İçerikler’i kullanmak istemesi halinde ilgili kullanıcıdan onay alacak ve İçerikler’i alınan bu onay kapsamında kullanacaktır.<br><br>
