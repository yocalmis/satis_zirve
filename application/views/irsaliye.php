...
<body>
	...
	<form action="<?php echo base_url(); ?>yonetim/irsaliye_al" method="post" >
	...
	<?php if ($data['side_menu'] == "Alış İrsaliye Ayarları") {echo '<input id="fat_turu" name="fat_turu" value="Alış" type="hidden" placeholder="İrsaliye Türü" class="material-container__input" />';}?>
			...
			<?php if ($data["cari_getir"]): foreach ($data["cari_getir"] as $dizi): ?>
				...
				<!--	<input id="mus" name="mus" type="text" required placeholder="Müşteri" class="material-container__input" />-->
					...
					<input  id="no" name="no" type="text" required placeholder="İrsaliye No" class="material-container__input" />
						<input
							id="duz_ta"
							name="duz_ta"
							type="text"  required
					...
					<input  id="seri" name="il" type="text" required placeholder="İlçe/İl" class="material-container__input" />
