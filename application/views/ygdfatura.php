...
<body>
	...
	<form action="<?php echo base_url(); ?>yonetim/fatura_alygd" method="post" >
...
<label id="top_box2" for="vehicle1">  </label><br>
	...
	<input  id="ygditemid" name="ygditemid" type="hidden" value="<?php echo $data["ygditemid"]; ?>" required placeholder="ygditemid" class="material-container__input" />
...
<div class="material-container__row fatura_row item">
			...
			<option selected value="<?php echo $data["ygdstokid"]; ?>"><?php echo $data["ygdadi"]; ?></option>
...
<input id="ekvkn" type="number" value="<?php echo $data["ek_vkn"][$n]; ?>" name="ekvkn_<?php echo $n + 1; ?>" min="1111111111" max="9999999999" required  placeholder="Vergi Kimlik no" class="material-container__input" />			
			<?php } ?>			
				...
				<div class="fatura_row__genel-veriler">
					<input id="pr" step="0.01" type="number" onkeyup="changeprc(<?php echo $n + 1; ?>);" name="prc_<?php echo $n + 1; ?>" value="<?php echo $dizi["birim_fiyat"]; ?>"  required min="0" placeholder="Fiyat" class="material-container__input urunInput" />
