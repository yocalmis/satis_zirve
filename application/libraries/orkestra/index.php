...
$conf = array("musteri"=>"zirveinternet", "kullanici"=>"zirveinternet", "sifre"=>"958162",
"url"=>"https://b2.orkestra.com.tr/efaturacim/servis.php", "apikey"=>"");
$efaturacim = new EFATURACIM_ISTEMCI($conf); 
if($efaturacim->login()){
      $efaturacim->showAsHtml("Sisteme girişiniz başarılı.","","success");
}else{
      $efaturacim->showAsHtml("Sisteme giriş yapılamadı ! 
Lütfen kullanıcı bilgilerini kontrol ediniz.","","danger"); 
}
...
if($sayfa==""){
	...
	$gyazilim = $efaturacim->vknSorgula("3880628557");
	$maliye    = $efaturacim->vknSorgula("6110368688");
	$tc_kimlik = $efaturacim->vknSorgula("11111111111");
	$efaturacim->showVariablesAsHtml( 
